...
const selectedCompanyOptions = companyArray.map(company => ({
  label: company.name,
  value: company.id,
}));
      ...
      <a-row :gutter="24" style="display: flex; align-items: flex-end; margin-top: 10px;">
        <a-col :span="6">
          <a-form-item label="Маркетплейс" name="marketplaceSelected">
            <a-select
              v-model:value="marketplaceSelected"
        ...
        <a-col :span="6">
          <a-form-item label="Компания" name="selectedCompany">
            <a-select
